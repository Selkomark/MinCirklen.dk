      ...
      >
        <div style={{ width: '100%', maxWidth: 480, display: 'flex', flexDirection: 'column', gap: 'clamp(20px, 4vw, 28px)' }}>
          ...
          >
            ...
            <Alert variant="safe">
              Your name is never shown to other participants unless you choose to turn
              anonymity off below.
            </Alert>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, cursor: 'pointer' }}>
                ...
                <span style={{ fontSize: 'var(--font-size-sm)', color: 'var(--text-primary)' }}>
                  Stay anonymous in circles — other participants see "Anonymous," not your
                  name
                </span>
              </label>
            ...
            <Button variant="safe" isDisabled={!canSubmit} onPress={onComplete} style={{ width: '100%' }}>
