...
const entries: CatalogEntry[] = [
  ...
  },
  {
    ...
    render: () => (
      <Card>
        ...
        <p style={{ margin: 0, color: 'var(--text-secondary)' }}>Tuesdays, 7pm — 6 participants</p>
      </Card>
    ),
    props: [
  ...
  },
  {
    name: 'Avatar',
    group: 'Data display',
    description: 'Participant identity. `anonymous` is the default for peer participants unless a real display name is explicit product intent.',
    render: () => (
  ...
  },
  {
    name: 'Tables',
    group: 'Content',
    description: 'For tabular data — schedules, participant lists, and the like.',
    render: () => (
      <Table striped>
        <thead>
          <tr>
  ...
  },
  {
    ...
    render: () => (
      <Navbar logo="MinCirklen">
        <Text variant="small" as="span">Circles</Text>
  ...
  },
  {
    name: 'Testimonial',
    group: 'Marketing',
    description: 'A quote card with attribution — anonymous by default, matching how participants are represented elsewhere in the product.',
    render: () => (
      <Testimonial
  ...
  },
  {
    ...
    code: `<Footer bottom="© 2026 MinCirklen.">\n  <FooterColumn title="Product">\n    <a href="/circles">Circles</a>\n  </FooterColumn>\n</Footer>`,
  },
]
